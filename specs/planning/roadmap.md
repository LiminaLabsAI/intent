...
| 10 | Precedent & Memory | prior intents + outcomes · recommend/reuse moves · confidence floor · promotion loop | §3.7 |
| 11 | Governance Thread | approval decision + human review + conditional · Governance-stop move | §4.3–4.5 |
| 12 | Handoff & Advisory | working-memory export · artifact expansion · cost/persona advisory | §5 |
| 13 | Feedback Flywheel | outcome capture → widen auto-approve envelope | §6 |
